...
> **当前在役**：`LMM_g_0.67.xml`；**待烧录（推荐）**：`LMM_g_0.70.xml` = 0.68 的 HMI **96W** + 每轴直控 + 0.69 的从站通道 Leg 96 + 0.70 的力峰值/原始值（`Force_rPeak`/`Force_wRaw`/`HMI_xForcePeakReset`）；设备树通道 `0x1000/0x1100` 各 96 字。
