...
| `src/PRG_Axis_Control.st` | 程序 | ETHERCAT 任务；组装 5×FB_Servo + 力/纠偏 FB → `AxisFb_*` |
...
| `src/FB_XLineTrack.st` | 功能块 | X 直行纠偏 / 原地旋转速度合成 |
...
- 死代码不许回魂：`FB_TCPServer` / `PRG_Force485` / `FB_XDiff` 已删（历史在 `attic/`）
